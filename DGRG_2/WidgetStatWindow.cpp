...
{
	m_StrDefaultText->SetText(UKismetTextLibrary::Conv_IntToText(m_StatManager->GetFinalCharStat().m_Str.m_fFinalValue));
}

void UWidgetStatWindow::SetStrBonusText()
{
	if (m_StatManager->GetFinalCharStat().m_Str.GetAbsBonusValue() <= 0)
	{
		FText NullText;
	...
	Args.Add(m_StatManager->GetFinalCharStat().m_Str.GetAbsBonusValue());
...
{
	m_AgilDefaultText->SetText(UKismetTextLibrary::Conv_IntToText(m_StatManager->GetFinalCharStat().m_Agil.m_fFinalValue));
}

void UWidgetStatWindow::SetAgilBonusText()
{
	if (m_StatManager->GetFinalCharStat().m_Agil.GetAbsBonusValue() <= 0)
	{
		FText NullText;
	...
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalCharStat().m_Agil.GetAbsBonusValue());
...
{
	m_LuckDefaultText->SetText(UKismetTextLibrary::Conv_IntToText(m_StatManager->GetFinalCharStat().m_Luck.m_fFinalValue));
}

void UWidgetStatWindow::SetLuckBonusText()
{
	if (m_StatManager->GetFinalCharStat().m_Luck.GetAbsBonusValue() <= 0)
	{
		FText NullText;
	...
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalCharStat().m_Luck.GetAbsBonusValue());
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_FireArmour.m_fFinalValue);
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_ElectricArmour.m_fFinalValue);
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_SoulArmour.m_fFinalValue);
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_AttackSpeed.m_fFinalValue);
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_MovementSpeed.m_fFinalValue);
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_AttackDamage.m_fFinalValue);
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_DropRateScale.m_fFinalValue);
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_ExpScale.m_fFinalValue);
...
{
	FFormatOrderedArguments Args;
	Args.Add(m_StatManager->GetFinalStat().m_GoldBonusScale.m_fFinalValue);
