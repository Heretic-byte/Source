...
public://charStat
	void IncreaseCharStat_Str(int v);
	void IncreaseCharStat_Agil(int v);
	void IncreaseCharStat_Luck(int v);
	void DecreaseCharStat_Str(int v);
	void DecreaseCharStat_Agil(int v);
	void DecreaseCharStat_Luck(int v);
protected:
