...
{
	m_PlayerStatManager->IncreaseCharStat_Str(value.m_OptionValue.GetFinalValue());
}

void UOptionManager::Add_AGIL_Abs(const FOption & value)
{
	m_PlayerStatManager->IncreaseCharStat_Agil(value.m_OptionValue.GetFinalValue());
}

void UOptionManager::Add_LUCK_Abs(const FOption & value)
{
	m_PlayerStatManager->IncreaseCharStat_Luck(value.m_OptionValue.GetFinalValue());
}
...
{
	m_PlayerStatManager->DecreaseCharStat_Str(value.m_OptionValue.GetFinalValue());
}

void UOptionManager::Remove_AGIL_Abs(const FOption & value)
{
	m_PlayerStatManager->DecreaseCharStat_Agil(value.m_OptionValue.GetFinalValue());
}

void UOptionManager::Remove_LUCK_Abs(const FOption & value)
{
	m_PlayerStatManager->DecreaseCharStat_Luck(value.m_OptionValue.GetFinalValue());
}
#pragma endregion
